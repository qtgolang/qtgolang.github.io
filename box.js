    ...
    e.sweetAlert = e.swal = function() {
        function n(e) {
            ...
            if (-1 !== [9, 13, 32, 27].indexOf(t)) {
                ...
                9 === t ? (n = -1 === o ? v : o === h.length - 1 ? h[0] : h[o + 1],
                q(e),
                n.focus(),
                i(n, u.confirmButtonColor)) : (n = 13 === t || 32 === t ? -1 === o ? v : void 0 : 27 !== t || b.hidden || "none" === b.style.display ? void 0 : b,
                void 0 !== n && E(n, e))
            }
        }
        function a(e) {
        ...
        }, p = d.querySelectorAll("button"), g = 0; g < p.length; g++)
            p[g].onclick = f,
            p[g].onmouseover = f,
            p[g].onmouseout = f,
            p[g].onmousedown = f,
