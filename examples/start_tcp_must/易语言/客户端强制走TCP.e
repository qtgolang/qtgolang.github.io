...
Sunny中间件.强制客户端走TCP (真)

' Sunny中间件.设置IE代理 ()  ' 设置IE代理
' Sunny中间件.关闭IE代理 ()'取消IE代理

.如果 (Sunny中间件.启动 ())
    ' 全部走TCP抓包，客户端不用安装证书，但是无法解码SSL数据
...
.判断开始 (消息类型 ＝ #Sunny_TCP_消息类型_即将连接)  ' 即将连接 2022-01-21新增
    ...
    ' ' 设置HTTP代理 admin=账号 123456=密码 127.0.0.1:8888=上游代理,30秒超时
    ' Sunny函数.Tcp_设置代理 (MessageId, “http://admin:123456@127.0.0.1:8888”,30*1000)
    ' ' 没有账号
    ' Sunny函数.Tcp_设置代理 (MessageId, “http://:@127.0.0.1:8888”,30*1000)
    ' ' 或者
    ' Sunny函数.Tcp_设置代理 (MessageId, “http://127.0.0.1:8888”,30*1000)

    ' ' 设置Socket5代理 admin=账号 123456=密码 127.0.0.1:8888=上游代理 ,30秒超时
    ' Sunny函数.Tcp_设置代理 (MessageId, “socket5://admin:123456@127.0.0.1:8888”,30*1000)
    ' ' 没有账号
    ' Sunny函数.Tcp_设置代理 (MessageId, “socket5://:@127.0.0.1:8888”,30*1000)
    ' ' 或者
    ' Sunny函数.Tcp_设置代理 (MessageId, “socket5://127.0.0.1:8888”,30*1000)
...
.判断 (消息类型 ＝ #Sunny_TCP_消息类型_断开连接)  ' 断开连接
