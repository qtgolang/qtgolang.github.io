...
' 设置全局上游HTTP代理 admin=账号 123456=密码 127.0.0.1:8888=上游代理
Sunny中间件.设置上游代理 (“http://admin:123456@127.0.0.1:8888”)
' 没有账号
Sunny中间件.设置上游代理 (“http://:@127.0.0.1:8888”)
' 或者
Sunny中间件.设置上游代理 (“http://127.0.0.1:8888”)

' 设置全局上游socket5代理 admin=账号 123456=密码 127.0.0.1:8888=上游代理
Sunny中间件.设置上游代理 (“socket5://admin:123456@127.0.0.1:8888”)
' 没有账号
Sunny中间件.设置上游代理 (“socket5://:@127.0.0.1:8888”)
' 或者
Sunny中间件.设置上游代理 (“socket5://127.0.0.1:8888”)
